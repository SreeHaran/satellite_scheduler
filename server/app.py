...
"""
FastAPI application for the Satellite Scheduler Environment.

This module creates an HTTP server that exposes the SatelliteSchedulerEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m satellite_scheduler.server.app
    ...
    multiple workers:
        uvicorn satellite_scheduler.server.app:app --workers 4
    """
    import uvicorn
