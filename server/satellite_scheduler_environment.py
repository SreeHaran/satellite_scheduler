...
focused mixin modules:
  ...
  - actions/slew.py   — explicit slew action
...
try:
    ...
    from .actions.slew import SlewMixin
    ...
    from server.actions.slew import SlewMixin  # type: ignore[no-redef]
...
class SatelliteSchedulerEnvironment(
    ...
    # ------------------------------------------------------------------
    # Wait and abort (kept here; too small to deserve their own module)
    # ------------------------------------------------------------------
